//sceed_frontend/src/components/bannerTwo.js
...
function TailorMadeSection() {
  return (
    <div className="bg-white p-8 mb-8 rounded-lg shadow-md flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/3 mt-8 md:mt-0 flex items-stretch">
