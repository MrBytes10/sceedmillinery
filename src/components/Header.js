...
const products = [
    { id: 1, name: "Feathered Veil Pearl Fascinator", price: 1300, description: "Elegant red feathered fascinator with pearls" },
    { id: 2, name: "Nested Feather Fascinator", price: 1700, description: "Beautiful blue nested feather fascinator" },
    // ... add more products
];
                    ...
                    <nav className={`${isMenuOpen ? "block" : "hidden"} sm:block`}>
                        <ul className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-6">
                            <li>
                                <Link
                                    to="/"
                                    className={`text-black hover:text-gray-600 font-medium text-sm sm:text-base ${isActive('/') ? 'opacity-50' : ''}`}>
                                    Home
                                </Link>
                            </li>
                            <li>
